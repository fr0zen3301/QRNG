...
Kept the QRNG module in C for core functions to maintain performance for the random number generation. The QRNG will be implemented with the [Qiskit](https://www.ibm.com/quantum/qiskit), quantum computing framework, and add some visualizations decided to move to Python. 
